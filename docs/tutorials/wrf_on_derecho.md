...
To know where the code exactly failed, turn on the traceback option in the configure.wrf file. By default the option is commented in the file. Uncomment them as shown below and recompile the code. 
```bash
