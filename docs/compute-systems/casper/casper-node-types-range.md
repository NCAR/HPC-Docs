...
type. It is recommended to utilize all of the resources of a node if you are planning to request an exclusive node for best performance.

# Resource Selection

| Node Type                | CPU            | Cores | Core Speed | Node Memory | GPU          | GPU Memory | Node Count | PBS Select Statement                                                   |
|--------------------------|----------------|-------|------------|-------------|--------------|------------|-------|--------------------------------------------------------------------------|
| High-Throughput Computing| Intel Cascade Lake   | 34    | 2.6GHz     | 354 GB      |              |            | 62    | -l select=1:ncpus=[1-34]:mem=[10-354gb]:cpu_type=cascadelake                             |
|                          | AMD Epyc 9554P           | 62    | 3.1GHz           | 733 GB     |              |            | 64     | -l select=1:ncpus=[1-64]:mem=[10-732]gb:cpu_type=genoa                  |
| Large Memory                         | Intel Cascade Lake   | 36    | 2.3GHz     | 1500 GB     |              |            | 2     | -l select=1:ncpus=[1-36]:mem=[400-1500]gb:cpu_type=cascadelake:mem=400GB                   |
