...
The official documentation is the best way to familiarize yourself with this tool. You will use the `s3` subcommand to work with objects. [AWS CLI S3 Command Reference](https://docs.aws.amazon.com/cli/latest/reference/s3/). The --endpoint-url option will be used with a value of endpoint from above.
