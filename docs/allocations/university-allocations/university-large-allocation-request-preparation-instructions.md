...
document is ready, submit your request via the [**Large Allocation
Request**](https://arc.ucar.edu/xras_submit/opportunities) form.
...
The [CHAP Allocation Review
Criteria](file:////display/RC/CHAP%253A+Allocation+Review+Criteria) provide
...
Click to download [Proposal Sample
1](file:////download/attachments/70549834/Example_Proposal_1_Spring2020.pdf%3fversion=1&modificationDate=1627406327000&api=v2) and [Proposal
Sample
2](file:////download/attachments/70549834/Example_Proposal_2_Fall2019.pdf%3fversion=1&modificationDate=1627406327000&api=v2).
...
allocated project and associated NSF award; see [Campaign
Storage](file:////display/RC/Campaign+Storage+file+system).
...
***3. Data analysis and visualization (DAV).*** Describe any planned
