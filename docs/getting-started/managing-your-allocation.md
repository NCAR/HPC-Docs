...
([SAM](https://sam.hpc.ucar.edu/)) to monitor charges against your
...
!!! info
    ...
    tasks related to managing your project. Visit [https://rchelp.ucar.edu](https://rchelp.ucar.edu) or call 303-497-2400.
...
of relevant [responsibilities](../getting-started/end-user-agreement.md) and [best practices](../best-practices-for-supercomputer-users/index.md).
